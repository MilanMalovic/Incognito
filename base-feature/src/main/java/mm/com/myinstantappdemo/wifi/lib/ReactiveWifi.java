...
public class ReactiveWifi {
    ...
    @NonNull
    protected static BroadcastReceiver createWifiScanResultsReceiver(
     ...
     */
    @RequiresPermission(ACCESS_WIFI_STATE)
    public static Observable<Integer> observeWifiSignalLevel(
    ...
    @NonNull
    protected static BroadcastReceiver createSignalLevelReceiver(
    ...
    public static Observable<SupplicantState> observeSupplicantState(final Context context) {
        ...
        return Observable.create((ObservableOnSubscribe<SupplicantState>) emitter -> {
    ...
    @NonNull
    protected static BroadcastReceiver createAccessPointChangesReceiver(
     ...
     */
    @RequiresPermission(ACCESS_WIFI_STATE)
    public static Observable<WifiState> observeWifiStateChange(
    ...
    @NonNull
    protected static BroadcastReceiver createWifiStateChangeReceiver(
